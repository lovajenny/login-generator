...
public class LoginGenerator {
     ...
     *
     * @param newloginService le service de login
     */
    public LoginGenerator(final LoginService newloginService) {
     ...
     * capitales et desaccentue. Le login genere doit etre unique
